...
Source0  : https://download.gnome.org/sources/libgudev/236/libgudev-236.tar.xz
...
%prep
%setup -q -n libgudev-236
cd %{_builddir}/libgudev-236
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616005400
...
cp %{_builddir}/libgudev-236/COPYING %{buildroot}/usr/share/package-licenses/libgudev/01a6b4bf79aca9b556822601186afab86e8c4fbf
